 ...
 */
@WebServlet("/CreateCateChih")
public class CreateCateChih extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public CreateCateChih() {
        super();
...
//		System.out.println(cateBean.getCate_Num());
		...
		request.setAttribute("newcate", cateBean); //設一個參數名稱(綠色的) 叫 newcate
